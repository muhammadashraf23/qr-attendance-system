        ...
        {success ? (
          <div className="w-full max-w-md bg-white border border-zinc-200 rounded-3xl p-8 text-center animate-fade-in shadow-xl">
            ...
            <p className="text-sm text-zinc-500 mt-2">
              Your account has been set up for <span className="text-black font-bold">{formData.institution_name}</span>.
            </p>
            ...
            <div className="bg-zinc-50 border border-zinc-200 rounded-2xl p-4 my-6 text-left text-xs space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-mono text-zinc-800">{formData.admin_email}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-zinc-500">Campus Geofence:</span>
                <span className="font-semibold text-zinc-900">{formData.geofence_radius}m radius set</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full py-3.5 bg-white hover:bg-zinc-100 text-zinc-900 font-bold rounded-xl transition border border-zinc-300"
              >
                Add Students →
              </button>
            </div>
