...
| 📄 [`5_TEAM_TASK_BREAKDOWN.md`](file:///e:/Projects/qr-attendance-system/docs/5_TEAM_TASK_BREAKDOWN.md) | **Team Task Breakdown & Group Deliverables** | 4-member group responsibility matrix, technical deliverables mapping, and marks rubric correlation (20 Coding + 10 Documentation). | Team Task Distribution |
